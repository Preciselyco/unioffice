...
import (
	...
	"github.com/Preciselyco/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/Preciselyco/unioffice")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/Preciselyco/unioffice
